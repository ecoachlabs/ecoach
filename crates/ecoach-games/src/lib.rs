...
pub use models::{
    ...
    SubmitTrapRoundInput, TrapChoiceOption, TrapMisconceptionReason, TrapReviewRound,
    TrapRoundCard, TrapRoundResult, TrapSessionReview, TrapSessionSnapshot, TrapsMode,
    TrapsState, TugOfWarState,
};
